...
export type TranslationDictionary = {
  ...
  magasin: {
    ...
    storePhone: string;
    storeLogo: string;
    storeLogoUpload: string;
    storeLogoReplace: string;
    storeLogoRemove: string;
    storeLogoEmpty: string;
    storeLogoPreview: string;
    storeLogoHelp: string;
    storeLogoInvalidType: string;
    storeLogoTooLarge: string;
    activeStore: string;
    membersCount: string;
    ...
    saleSavedPrinterDisconnected: string;
    reprintLastTicket: string;
    ...
    exportPointageXlsx: string;
    exportPointageXlsxError: string;
    importPointageGuideEmail: string;
    importPointageGuideEmailSent: string;
    importPointageGuideEmailError: string;
    employee: string;
    date: string;
    hours: string;
    clockIn: string;
    ...
    targetStores: string;
    selectTargetStores: string;
    mbrStockArticles: string;
    noEligibleStores: string;
    ineligibleStoreMissingProducts: string;
    sellingPrice: string;
    startDate: string;
    endDate: string;
    ...
    promotionCreatedForStores: (n: number) => string;
