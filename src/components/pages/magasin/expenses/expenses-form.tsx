										...
										<Card elevation={2} sx={{ borderRadius: 2 }}>
											<CardContent sx={{ p: 3 }}>
												...
												<Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: 'repeat(2, minmax(0, 1fr))' }, gap: 2.5 }}>
													...
													<ThemeProvider theme={dropdownTheme}><TextField select size="small" label={t.magasin.paymentStatus} value={formik.values.payment_status} onChange={(event) => void formik.setFieldValue('payment_status', event.target.value)} InputProps={{ startAdornment: <InputAdornment position="start"><PaymentsIcon fontSize="small" /></InputAdornment> }} fullWidth><MenuItem value="paid">Paid</MenuItem><MenuItem value="payable">Payable</MenuItem></TextField></ThemeProvider>
